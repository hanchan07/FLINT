(function() {
...
})()(
	{
		...
		3: [
			function(require, module, exports) {
				...
				var ES5 = {
					...
					FromPropertyDescriptor: function FromPropertyDescriptor(
						Desc
					) {
						if (typeof Desc === 'undefined') {
							return Desc;
					...
					ToPropertyDescriptor: function ToPropertyDescriptor(Obj) {
						...
						if (has(Obj, 'enumerable')) {
							desc['[[Enumerable]]'] = this.ToBoolean(
								Obj.enumerable
							);
						}
						if (has(Obj, 'configurable')) {
							desc['[[Configurable]]'] = this.ToBoolean(
								Obj.configurable
							);
						}
						if (has(Obj, 'value')) {
		...
		8: [
			...
			{ './helpers/isPrimitive': 9, 'is-callable': 15 },
		],
		9: [
			function(require, module, exports) {
		...
		17: [
			function(require, module, exports) {
				...
				function transformPhrase(phrase, substitutions, locale) {
					...
					result = replace.call(result, tokenRegex, function(
						expression,
						argument
					) {
						if (
				...
				function Polyglot(options) {
					...
					var allowMissing = opts.allowMissing
						? transformPhrase
						: null;
					this.onMissingKey =
						typeof opts.onMissingKey === 'function'
							? opts.onMissingKey
							: allowMissing;
		...
		20: [
			...
			{ 'es-abstract/es5': 3, 'function-bind': 13 },
		],
		21: [
			function(require, module, exports) {
				'use strict';
		...
		23: [
			...
			{ './polyfill': 22, 'define-properties': 2 },
		],
		24: [
			function(require, module, exports) {
				(function(process) {
